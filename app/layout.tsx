            ...
            <body className={inter.className}>
                <div className="grid min-h-screen w-full md:grid-cols-[240px_1fr] lg:grid-cols-[300px_1fr] bg-white">
                    ...
                    <div className="flex flex-col">
                        <Navbar />
                        <main className="flex flex-1 flex-col gap-8 p-6 lg:gap-10 lg:p-8 bg-gradient-to-br from-slate-50 via-emerald-50/20 to-teal-50/20 animate-[fadeIn_0.8s_ease-out]">
                            {children}
                        </main>
                    </div>
                </div>
